module.exports = function ConverterFactory(source, dest, logger, 
    async, fs, path, childProcess, parser, recursive, xmlbuilder, xslt, xmldoc, glob) {
    var tasks = {},
    ...
    var resourceTasks = require('./tasks/resources')(source, dest, project, fs, path, xmlbuilder, xslt, xmldoc, glob, logger),
